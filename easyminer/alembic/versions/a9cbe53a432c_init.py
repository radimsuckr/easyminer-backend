...
Revision ID: a9cbe53a432c
Revises:
Create Date: 2025-05-18 20:26:18.749180+02:00
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["attribute_id"], ["dataset_attribute.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("value", "attribute_id", name="uq_value_attribute"),
    )
